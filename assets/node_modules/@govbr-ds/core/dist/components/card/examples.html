...
<html lang="pt-BR">
  ...
  <body>
    <div class="container-fluid">
      <p class="h4 mt-5">Card simples</p>
      <div class="row">
      ...
      <p class="h4 mt-5">Card completo</p>
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="br-card">
            <div class="card-header">
              <div class="d-flex"><span class="br-avatar mt-1" title="Fulano da Silva"><span class="image"><img src="https://picsum.photos/id/823/400" alt="Avatar"/></span></span>
                <div class="ml-3">
      ...
      <p class="h4 mt-5">Card com expansão</p>
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="br-card">
            <div class="card-header">
            ...
            <div class="card-footer">
              <div class="text-right">
                <button class="br-button circle" type="button" aria-label="Expandir o card" data-toggle="collapse" data-target="expanded" aria-controls="expanded" aria-expanded="false" data-visible="false"><i class="fas fa-chevron-down" aria-hidden="true"></i>
                </button>
              </div>
              <div id="expanded" hidden="hidden">
      ...
      <p class="h4 mt-5">Card desativado</p>
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
          <p class="h4 mt-5">Card com hover</p>
      ...
      <div class="row mt-5">
        <div class="col-sm-6 col-md-4 col-lg-3">
          <p class="h5">Card com altura fixa </p>
