                    ...
                    <nav class="tab-nav">
                      <ul>
                        <li class="tab-item notification-tooltip" data-tooltip-text="Alertas">
                          <button type="button" aria-label="Alertas" data-panel="notification-panel-1-74906"><span class="name"><i class="fas fa-bell" aria-hidden="true"></i></span></button>
                        </li>
                        <li class="tab-item notification-tooltip active" data-tooltip-text="Mensagens">
                          <button type="button" aria-label="Mensagens" data-panel="notification-panel-2-74906"><span class="name"><i class="fas fa-envelope" aria-hidden="true"></i></span></button>
                        </li>
                      </ul>
                    </nav>
                    <div class="tab-content">
                      <div class="tab-panel" id="notification-panel-1-74906">
                        <div class="br-list">
                      ...
                      <div class="tab-panel active" id="notification-panel-2-74906">
                        <div class="br-list">
    ...
    <div class="header-bottom">
      ...
      <div class="header-search">
        <div class="br-input has-icon">
          <label for="searchbox-17376">Texto da pesquisa</label>
          <input id="searchbox-17376" type="text" placeholder="O que você procura?"/>
